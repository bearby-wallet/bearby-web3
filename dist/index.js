...
var _Massa_provider, _Massa_wallet, _Massa_subject;
class Massa {
    constructor(provider, wallet, subject) {
        _Massa_provider.set(this, void 0);
        _Massa_wallet.set(this, void 0);
        _Massa_subject.set(this, void 0);
        __classPrivateFieldSet(this, _Massa_provider, provider, "f");
        __classPrivateFieldSet(this, _Massa_wallet, wallet, "f");
        __classPrivateFieldSet(this, _Massa_subject, subject, "f");
    }
    ...
    subscribe(cb) {
        const obs = __classPrivateFieldGet(this, _Massa_subject, "f").on((msg) => {
...
_Massa_provider = new WeakMap(), _Massa_wallet = new WeakMap(), _Massa_subject = new WeakMap();
...
class Web3 {
    constructor() {
        ...
        this.massa = new Massa(__classPrivateFieldGet(this, _Web3_provider, "f"), this.wallet, __classPrivateFieldGet(this, _Web3_handler, "f").subject);
        if (globalThis.window) {
